package Dia026.Formatacao.Teste;
...
public class DateTimeFormatterTeste {
    public static void main(String[] args) {
        ...
        LocalDate parse3 = LocalDate.parse("2021-02-19+05:00",DateTimeFormatter.ISO_DATE);
        LocalDate parse2 = LocalDate.parse("2021-02-19",DateTimeFormatter.ISO_LOCAL_DATE);
        ...
        LocalDate parseBR = LocalDate.parse("19/02/2025", formatterBR);
